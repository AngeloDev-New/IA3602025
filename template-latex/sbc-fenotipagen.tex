...
% \author{Vinicius Tessele\inst{1}, Claudio Honorio da Silva Junior\inst{1}, Angelo Gabriel\inst{1}, Leonardo Tampelini\inst{1}}

% \address{Departamento de Inteligência Artificial -- Biopark Educação\\
%   Toledo -- PR -- Brasil
%   \email{\{vinicius.tessele,claudio.silva,angelo.gabriel,leonardo.tampelini\}@biopark.edu.br}
% }
...
Random Forest, as illustrated in code~\ref{fig:randomforest}, is a machine learning model based on decision trees. It builds multiple trees and combines their results to obtain more robust predictions \cite{hastie2009elements}.
