...
\textbf{keywords:}Artificial Neural Networks, Disease Classification, Deep Learning.
\end{abstract}
...
\textbf{Palavras-chave:}Redes Neurais Artificiais, Classificação de Doenças, Aprendizado Profundo. 
