...
% Claudio Honorio da Silva Junior\inst{}, Leonardo Tampelini\inst{1}}
...
\textbf{keywords:}Multimodal Artificial Intelligence; Medical Imaging; MedGemma 4B-IT.
\end{abstract}
...
\textbf{Palavras-chave:} Inteligência Artificial Multimodal; Imagens Médicas; MedGemma 4B-IT.
...
\begin{figure}[!h]
\centering
\includegraphics[width=5in]{figs/med.png}
\caption{Imagem Medica}
\label{fig:med}
\end{figure}
...
\caption{Distribuição das categorias BI-RADS O Autor (2025)}
\label{fig:graph}
